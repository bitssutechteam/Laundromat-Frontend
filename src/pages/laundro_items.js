 ...
 export default function LaundroItems() {
  ...
  const handleUpdateSignings = (data_) => {
    ...
    var config_ = {
      method: "post",
      maxBodyLength: Infinity,
      url: `${api_url}update_laundro_siginigs`,
      headers: {
        "x-authorization":
          "048f1579b8b8f75f609f036ecb26623ddd0f58d4ff9193a14d4284ac4ff0c87b9093ed08947f25ea72cd141b23be5f2b12e10ccf4522c327f8172f76d1554fb6",
        "x-origin": "826bead8ad2ad9ce955028045788f371",
  ...
  const handleDeleteSignings = (idxData) => {
    ...
    var config_ = {
      method: "post",
      url: `${api_url}delete_laundro_signings`,
      headers: {
        "x-authorization":
          "048f1579b8b8f75f609f036ecb26623ddd0f58d4ff9193a14d4284ac4ff0c87b9093ed08947f25ea72cd141b23be5f2b12e10ccf4522c327f8172f76d1554fb6",
        "x-origin": "826bead8ad2ad9ce955028045788f371",
...
function Signings({
  ...
  const token = localStorage.getItem("token");
  const api_url=process.env.REACT_APP_Test_API_URL
  ...
  const  callApi = async   () => {
    ...
    var config_ = {
         method: "post",
         maxBodyLength: Infinity,
         url: `${api_url}mark_all_signings_billed`,
         headers: {
           "x-authorization":
             "048f1579b8b8f75f609f036ecb26623ddd0f58d4ff9193a14d4284ac4ff0c87b9093ed08947f25ea72cd141b23be5f2b12e10ccf4522c327f8172f76d1554fb6",
           "x-origin": "826bead8ad2ad9ce955028045788f371",
